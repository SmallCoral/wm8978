...
#define TUD_AUDIO10_SPEAKER_STEREO_FB_DESC_LEN(_nfreqs) ( \
    ...
    TUD_AUDIO10_DESC_FEATURE_UNIT_LEN(2) + TUD_AUDIO10_DESC_STD_AS_LEN + \
    TUD_AUDIO10_DESC_STD_AS_LEN + TUD_AUDIO10_DESC_CS_AS_INT_LEN + \
...
#define TUD_AUDIO10_SPEAKER_STEREO_FB_DESCRIPTOR( \
    _itfnum, _stridx, _bytes, _bits, _epout, _epoutsize, _epfb, ...) \
    TUD_AUDIO10_DESC_STD_AC(_itfnum, 0x00, _stridx), \
    TUD_AUDIO10_DESC_CS_AC(0x0100, \
        TUD_AUDIO10_DESC_INPUT_TERM_LEN + TUD_AUDIO10_DESC_OUTPUT_TERM_LEN + \
        TUD_AUDIO10_DESC_FEATURE_UNIT_LEN(2), (_itfnum) + 1), \
    TUD_AUDIO10_DESC_INPUT_TERM(UAC1_ENTITY_INPUT_TERMINAL, \
        AUDIO_TERM_TYPE_USB_STREAMING, 0x00, 0x02, \
        AUDIO10_CHANNEL_CONFIG_LEFT_FRONT | AUDIO10_CHANNEL_CONFIG_RIGHT_FRONT, \
        0x00, 0x00), \
    TUD_AUDIO10_DESC_OUTPUT_TERM(UAC1_ENTITY_OUTPUT_TERMINAL, \
        AUDIO_TERM_TYPE_OUT_HEADPHONES, 0x00, UAC1_ENTITY_FEATURE_UNIT, 0x00), \
    TUD_AUDIO10_DESC_FEATURE_UNIT(UAC1_ENTITY_FEATURE_UNIT, \
        UAC1_ENTITY_INPUT_TERMINAL, 0x00, \
        AUDIO10_FU_CONTROL_BM_MUTE | AUDIO10_FU_CONTROL_BM_VOLUME, \
        AUDIO10_FU_CONTROL_BM_MUTE | AUDIO10_FU_CONTROL_BM_VOLUME, \
        AUDIO10_FU_CONTROL_BM_MUTE | AUDIO10_FU_CONTROL_BM_VOLUME), \
    TUD_AUDIO10_DESC_STD_AS_INT((_itfnum) + 1, 0x00, 0x00, 0x00), \
    TUD_AUDIO10_DESC_STD_AS_INT((_itfnum) + 1, 0x01, 0x02, 0x00), \
    TUD_AUDIO10_DESC_CS_AS_INT(UAC1_ENTITY_INPUT_TERMINAL, 0x00, \
        AUDIO10_DATA_FORMAT_TYPE_I_PCM), \
    TUD_AUDIO10_DESC_TYPE_I_FORMAT(0x02, _bytes, _bits, __VA_ARGS__), \
